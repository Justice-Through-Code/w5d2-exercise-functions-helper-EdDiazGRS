...
# This is a dictionary inside of a list. It's a dictionary with 3 key value pairs inside of a list.
...
# HINT: Does `return` print anything out? --> no, it doesnt print anything out
count_books()
